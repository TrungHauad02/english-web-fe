...
function ListTest_Skill({ list, quote, title, bg }) {
  ...
  return (
    <Box>
      <ImageContainer>
        <img
          src="https://firebasestorage.googleapis.com/v0/b/englishweb-5a6ce.appspot.com/o/static%2Fbg_test.png?alt=media"
          alt="Test"
            ...
            <Grid item xs={12} sm={4} key={index}>
              <TestCard>
                <CardContent>
                  ...
                  <Typography>
                    <strong>Number of Questions:</strong> {test.questions}
                  </Typography>
                  <Typography>
