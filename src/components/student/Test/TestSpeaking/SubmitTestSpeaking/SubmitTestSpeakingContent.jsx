...
const SubmitTestSpeakignContent = ({ submitTestSpeakingList, testSpeakingList, focusedSerial, onResetFocus }) => {
...
SubmitTestSpeakignContent.propTypes = {
    submitTestSpeakingList: PropTypes.arrayOf(PropTypes.object),
    testSpeakingList: PropTypes.arrayOf(PropTypes.object),
